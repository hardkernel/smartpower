...
//    #define CLOCK_FREQ 48000000
    ...
    #define mInitLCDPort()      {TRISAbits.TRISA1=0; LATAbits.LATA1=1; LATD &= 0x0F; TRISD &= 0x0F; LATE &= 0xF8; TRISE &= 0xF8; LATA &= 0x0F; TRISA &= 0x0F;}
#else
...
///
    #define mLCD_D4             LATDbits.LATD4
    #define mLCD_D5             LATDbits.LATD5
    #define mLCD_D6             LATDbits.LATD6
    #define mLCD_D7             LATDbits.LATD7
//    #define mLCD_DATA(x)        {   LATD &= 0x0F; LATD |= (x & 0xF0); LATA &= 0x0F; LATA |= ((x << 4) & 0xF0); }
    #define mLCD_DATA(x)        {   LATD &= 0x0F; LATD |= (x & 0xF0); }
    #define mLCD_E              LATEbits.LATE0
    #define mLCD_RW             LATEbits.LATE1
    #define mLCD_RS             LATEbits.LATE2
///
    ...
    /** SWITCH *********************************************************/
#if defined(HARDKERNEL_PIC18F45K50)
    #define mInitAllSwitches()  TRISDbits.TRISD2=1;TRISDbits.TRISD3=1;TRISBbits.TRISB5=1;
#else
    ...
    #define mInitDetect()       {TRISCbits.TRISC0=1;TRISBbits.TRISB4=1;}
   
    #define mInitUSART()		{TRISCbits.TRISC6=0;TRISCbits.TRISC7=1;}
